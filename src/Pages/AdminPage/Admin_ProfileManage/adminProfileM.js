...
function AdminProfileManage() {
  ...
  const dummyEmployees = [
    { id: 'EMP001', name: 'John Doe', department: 'IT', role: 'Developer' },
    { id: 'EMP002', name: 'Jane Smith', department: 'HR', role: 'Manager' },
    { id: 'EMP003', name: 'David Brown', department: 'Finance', role: 'Accountant' },
  ];
            ...
            <tbody>
              {dummyEmployees.map((emp, idx) => (
                <tr key={idx}>
                  ...
                  <td>{emp.role}</td>
                  <td>
                    <button className="action-btn" onClick={() => openUpdateModal(emp)}>
    ...
    <div className="modal-content large">
      ...
      <form className="admin-member-form two-column-form" onSubmit={handleUpdateSubmit}>
        ...
        <div className="admin-button-group">
          {isModified && <button type="submit" className="admin-submit-btn">Update</button>}
